...
describe('ng-require:module generator', function () {
  ...
  beforeEach(function (done) {
    helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
      ...
      this.app = helpers.createGenerator('ng-require:app',  ['../../app'], [appName], {
        'appPath': '../../app',
  ...
  it('creates expected files for ng-require:module', function (done) {
    var expected = [
